...
async def start(client:Client, message): 
    ...
    if AUTH_CHANNEL and not await is_req_subscribed(client, message):
        ...
        await client.send_message(
            ...
            text="🔺Aɢᴀʀ ᴀᴀᴘᴋᴏ ᴍᴏᴠɪᴇ ᴄʜᴀʜɪʏᴇ ᴛᴏ ᴘʜᴇʟᴇ niche deye button ⛔️ ᴊᴏɪɴ ɴᴏᴡ ⛔️ pe click kare\n🔺'Uᴘᴅᴀᴛᴇ Cʜᴀɴɴᴇʟ' ᴍᴇ ᴊᴏɪɴ ʜᴏ ᴊᴀo\n🔺ᴜꜱᴋᴇ ʙᴀᴀᴅ 'Tʀʏ Aɢᴀɪɴ' ʙᴜᴛᴛᴏɴ ᴘᴇ ᴄʟɪᴄᴋ ᴋᴀʀᴏ movie mil jayegi\n👉anurino_maingroupp\n\n📌 Yᴏᴜ ʜᴀᴠᴇ ᴛᴏ ᴊᴏɪɴ ᴏᴜʀ 'Uᴘᴅᴀᴛᴇ Cʜᴀɴɴᴇʟ' ғɪʀsᴛ.(Click on ⛔️ ᴊᴏɪɴ ɴᴏᴡ ⛔️ button )\n🔺Tʜᴇɴ ᴄʟɪᴄᴋ ᴏɴ ᴛʜᴇ 'Tʀʏ Aɢᴀɪɴ' ʙᴜᴛᴛᴏɴ ʙᴇʟᴏᴡ\n🔺Cʟɪᴄᴋ ❍ Jᴏɪɴ Mʏ Main Cʜᴀɴɴᴇʟ ❍",
            reply_markup=InlineKeyboardMarkup(btn),
            parse_mode=enums.ParseMode.HTML
        )
        return
...
async def save_tutorial(client, message):
    ...
    try:
        ...
        return await message.reply_text("<b>Command Incomplete!!\n\nuse like this -</b>\n\n<code>/set_caption https://t.me/jain_shabb</code>")    
